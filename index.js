...
//first .map: over each tutorial
  //second .map: iterate over each word in tutorial (to capitalize the word)

//titleCased returns new array where each tutorial is uppercased
const titleCased = () => {
